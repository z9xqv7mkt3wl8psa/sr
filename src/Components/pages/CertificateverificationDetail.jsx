...
import certificateverificationData from "../../data/certificateverificationData";

const CertificateverificationDetail = () => {
  const { id } = useParams();
  const certificateverification = certificateverificationData.find((item) => item.id === id);

  if (!certificateverification) return <h2 className="text-center text-red-500 mt-10">❌ Page Not Found</h2>;
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white shadow-md border p-6 mt-6 text-sm leading-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 border mt-6">
        <div className="border p-3">
          ...
          <ul className="mt-2 space-y-1">
            {certificateverification.importantDates.map((item, i) => (
        ...
        <div className="border p-3">
          ...
          <ul className="mt-2 space-y-1">
            {certificateverification.applicationFees.map((item, i) => (
              <li key={i} className={getHighlightClass(item.highlight)}>
                <b>{item.label}:</b> {item.value}
              </li>
            ))}
      ...
      <div className="border p-3 mt-6">
        ...
        <ul className="mt-2 space-y-1">
          {certificateverification.ageLimit.map((item, i) => (
            <li key={i} className={getHighlightClass(item.highlight)}>
      ...
      <div className="border p-3 mt-6">
        ...
        <table className="w-full border mt-2 text-center">
          ...
          <tbody>
            {certificateverification.vacancies.map((v, i) => (
              <tr key={i}>
      ...
      <div className="border p-3 mt-6">
        ...
        <ul className="list-disc pl-6 mt-2 space-y-1">
          {certificateverification.qualifications.map((q, i) => (
      ...
      <div className="border p-3 mt-6">
        ...
        <ul className="list-disc pl-6 mt-2 space-y-1">
          {certificateverification.requiredDocs.map((doc, i) => <li key={i}>{doc}</li>)}
        </ul>
      </div>
      ...
      <div className="border p-3 mt-6">
        ...
        <ul className="list-disc pl-6 mt-2 space-y-1">
          {certificateverification.selectionProcess.map((step, i) => <li key={i}>{step}</li>)}
        </ul>
      </div>
      ...
      <div className="border p-3 mt-6">
        ...
        <ol className="list-decimal pl-6 mt-2 space-y-1">
          {certificateverification.howToApply.map((step, i) => <li key={i}>{step}</li>)}
        </ol>
      </div>
...
<div className="border p-3 mt-6">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
    {certificateverification.linksBox.map((link, i) => (
      <div
        key={i}
      ...
      <div className="border p-3 mt-6">
        ...
        {certificateverification.faqs.map((faq, i) => (
...
export default CertificateverificationDetail;
